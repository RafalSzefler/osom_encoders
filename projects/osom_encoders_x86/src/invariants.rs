...
use crate::models::{Displacement, GPR, GPRKind, GPROrMemory, Immediate8, Immediate16, Immediate32, Immediate64, Memory, Scale, Size};
...
const _INVARIANTS: () = {
    ...
    assert!(size_of::<GPROrMemory>() <= 16, "Expected GPROrMemory to be at most 16 bytes");
