...
#[inline(always)]
pub const fn encode_lock() -> EncodedX86Instruction {
    unsafe { EncodedX86Instruction::from_array([0xF0]) }
}

/// Add imm8 to AL.
#[inline(always)]
pub const fn encode_add_AL_imm8(imm8: Immediate8) -> EncodedX86Instruction {
    unsafe { utils::enc_I::encode_I_imm8([0x04], imm8) }
}

/// Add imm16 to AX.
#[inline(always)]
pub const fn encode_add_AX_imm16(imm16: Immediate16) -> EncodedX86Instruction {
    unsafe { utils::enc_I::encode_I_imm16_operand_size_override([0x05], imm16) }
}

/// Add imm32 to EAX.
#[inline(always)]
pub const fn encode_add_EAX_imm32(imm32: Immediate32) -> EncodedX86Instruction {
