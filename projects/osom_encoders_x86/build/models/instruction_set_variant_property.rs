bitflags::bitflags! {
    ...
    pub struct VariantProperty: u8 {
        ...
        const Bit64Only  = 0b00000001;
        const Bit32Only  = 0b00000010;
        const PrefixRex  = 0b00000100;
        const PrefixRexW = 0b00001000;

        /// Operand size override prefix.
        const PrefixOSO     = 0b00010000;
    }
}
...
impl TryFrom<&str> for VariantProperty {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            "Bit64Only" => Ok(VariantProperty::Bit64Only),
            "Bit32Only" => Ok(VariantProperty::Bit32Only),
